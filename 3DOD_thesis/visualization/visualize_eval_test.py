...
import sys
sys.path.append("/content/3DOD_thesis/utils") # NOTE! you'll have to adapt this for your file structure
...
def create3Dbbox(center, h, w, l, r_y, type="pred"):
    ...
    cylinder_0_3 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_0_3)
    ...
    cylinder_1_2 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_1_2)
    ...
    cylinder_4_7 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_4_7)
    ...
    cylinder_5_6 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_5_6)
    ...
    cylinder_0_1 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_0_1)
    ...
    cylinder_3_2 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_3_2)
    ...
    cylinder_4_5 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_4_5)
    ...
    cylinder_7_6 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_7_6)
    ...
    cylinder_0_4 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_0_4)
    ...
    cylinder_3_7 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_3_7)
    ...
    cylinder_1_5 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_1_5)
    ...
    cylinder_2_6 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_2_6)
    ...
    cylinder_0_1_3_2 = o3d.geometry.create_mesh_cylinder(radius=0.025, height=length_0_1_3_2)
...
#sys.path.append("/content/3DOD_thesis/Open3D/build/lib") # NOTE! you'll have to adapt this for your file structure
from open3d import *
import open3d as o3d

project_dir = "/content/3DOD_thesis/" # NOTE! you'll have to adapt this for your file structure
...
# Frustum-PointNet:
#with open("/content/3DOD_thesis/training_logs/model_Frustum-PointNet_eval_test/eval_dict_test.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
...
# ##################################
# # Image-Only:
with open("/content/3DOD_thesis/training_logs/model_Image-Only_eval_test/eval_dict_test.pkl", "rb") as file: # NOTE! you'll have to adapt this for your file structure
    eval_dict = pickle.load(file)
i=0
...
# NOTE! remove this if statement in case you have access to the complete KITTI dataset
    ...
    pcd.points = o3d.utility.Vector3dVector(point_cloud_xyz_camera)
    ...
    cv2.imwrite("/content/final/"+str(img_id)+".png", combined_img)
    i=i+1
