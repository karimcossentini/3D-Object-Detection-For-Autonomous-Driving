...
network = ImgNet("Image-Only_eval_test", project_dir="/content/3DOD_thesis")
network.load_state_dict(torch.load("/content/3DOD_thesis/pretrained_models/model_10_2_epoch_400.pth"))
network = network.cuda()

network.eval() # (set in evaluation mode, this affects BatchNorm and dropout)

val_dataset = DatasetKittiTest(kitti_data_path="/content/3DOD_thesis/data/kitti",
                               kitti_meta_path="/content/3DOD_thesis/data/kitti/meta")
